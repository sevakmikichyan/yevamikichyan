...
export default function ArmenianBattles() {
  const data = [
    ...
    {
      id: 4,
      battle: "Աքսիումի ճակատամարտ",
      year: "մ.թ.ա. 31 թ.",
      commander: "Օկտավիանոս, Մարկ Անթոնիոս",
      sides: "Հռոմ (Օկտավիանոս) – Մարկ Անթոնիոս և Կլեոպատրա",
      strategy: "Նավատորմի կենտրոնացված հարված և անակնկալ շրջափակում",
    },
    {
      id: 5,
      battle: "Կրոսիի ճակատամարտ",
      year: "մ.թ.ա. 202 թ.",
      commander: "Սկիպիոն Աֆրիկանուս, Հաննիբալ",
      sides: "Հռոմ – Կարտագին",
      strategy: "Տակտիկական շարժունակություն, ֆալանգի և հետախուզության օգտագործում",
    },
    {
      id: 6,
      battle: "Սալամիսի ծովային ճակատամարտ",
      year: "մ.թ.ա. 480 թ.",
      commander: "Թեմիստոկլես, Քսերքսես I",
      sides: "Հունական նավատորմ – Պարսկական նավատորմ",
      strategy: "Նեղ տարածքում շրջափակում և թշնամու նավատորմի տեղաշարժի սահմանափակում",
    },
  ];
